...
Bei einem qualitativen Vergleich fällt auf, dass die `Random Forest` und `Maximumlikelihood` Klassifikation sehr ähnliche Ergebnisse von vergleichbarer Güte liefern.  
