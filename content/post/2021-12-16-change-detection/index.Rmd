...
tags:
  ...
  - change detection   
  - forest
subtitle: 'Von unüberwachter Clusteranalyse bis über Maximum-Likelihood- bis zu Maschinenlernverfahren wie Random Forest'
...
<p>
  <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapse_class" aria-expanded="false" aria-controls="collapse_class">
    Exkurs Klassifikation
  </button>
<div class="collapse" id="collapse_clss">
