...
1. Unüberwachte/überwachte Klassifizierung 
  ...
  * Rekursive Partitionierung und Regressionsbäume (über `caret`)
...
* Modified Soil Adjusted Vegetation Index [SAVI](https://www.indexdatabase.de/db/i-single.php?id=87) * Enhanced Vegetation Index [EVI](https://www.indexdatabase.de/db/i-single.php?id=16).
...
* Positive and negative predictive values geben für clearcut bzw. other an. Sie sind um die reale Häufikeit korrigiert und ein Schätzmass für die Präzision bzw. Pereformance des Modells. 
Trotz der hohen Werte sehen wir das die Klasse clearcut deutlich abfällt. Insgesamt kann das Modell jedoch als gut bezeichnet werden.
