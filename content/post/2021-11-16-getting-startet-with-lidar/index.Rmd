...
For the following, make sure these libraries are part of your setup (should be the case if you follow [project oriented workflow post](https://gisma-courses.github.io/gi-modules/post/2021-11-13-project-oriented-workflow).
...
```{r data1, comment = NA, echo=TRUE, message = FALSE, warnings = FALSE, results = FALSE}
...
```{r plot1, comment = NA, echo=TRUE, message = FALSE, warnings = FALSE, results = TRUE}
library(rgl)
