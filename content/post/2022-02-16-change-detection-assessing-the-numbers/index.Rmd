...
In der Literatur zur Fernerkundung wurde frühzeitig eine Vielzahl von Methoden zur Bewertung der Genauigkeit diskutiert  (Aronoff, 1982; Kalkhan et al., 1996; Koukoulas und Blackburn, 2001; Piper, 1983; Rosenfield und Fitzpatrick-Lins, 1986), allerdings aufgrund der Schwerigektien ausreichend und qualitativ hochwertige Felddatensätze zu erheben in der Vergangenheit Selten durchgeführt.

Dder gebräuchlichste Ansatz ist Fehlermatrix als Grundlage zur zur Bewertung der Genauigkeit Die korrekte und Fwehlklassifikation, die Gesamtgenauigkeit und die Kappa-Koeffizienten sind üblicherweise die grundlegenden Kennzahlen der Genauigkeitsbewertung.
