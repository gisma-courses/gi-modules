...
In our example, `bfastmonitor()` returns change date and change magnitude values per time series and we can use `reduce_time()`. The script below calculates the [kNDVI](https://advances.sciencemag.org/content/7/9/eabc7447), applies `bfastmonitor()`, and properly handles errors e.g. due to missing data with `tryCatch()`. Finally, the resulting change dates and magnitudes of change for all pixel of the time series are written to disk as a netCDF file. The results shows the changes starting at 1/2019 until 12/2021 and Identify pretty well the dynamical impacts of drought and bark beetle in the Marburg University Forest (MOF).
...
<iframe align="center" src="m2.html" width="800" height="680" frameborder="0" allowfullscreen="allowfullscreen">
</iframe>
<figcaption>*Magnitude Change Map *</figcaption>

<p>

<iframe align="center" src="m1.html" width="800" height="680" frameborder="0" allowfullscreen="allowfullscreen">
</iframe>
