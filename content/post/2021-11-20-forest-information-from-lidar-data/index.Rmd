...
```{r echo=FALSE}
blogdown::shortcode("alert", "NOTE", "info" ,"black", "black", "Please copy the following script into the subfolder *functions*. It might be necessary to work around a unexpected behaviour with the returnd vrt files.")
```


<script src="https://gist.github.com/gisma/5127a360728666eddb96807ad37bb475.js"></script>

```{r echo=FALSE}
blogdown::shortcode("alert", "NOTE", "danger" ,"black", "black", "The below script is **not** using the original course data. It downloads a small sample. Please download the original data and **adapt** the below script! Please also enlarge the chunksize at least to 250!")
```




```{r warmup,  message=FALSE, warning=FALSE, cache=FALSE, render=TRUE}
knitr::knit_global()
require(envimaR)
